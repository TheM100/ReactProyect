...
export default function PostCard({ postData }) {
    ...
    return (
        // Link
        <Link to={`/postDetail/${postData._id}`} className="bg-white rounded-md mb-5 cursor-pointer hover:border-zinc-500/50 ">
                ...
                <div className="p-5">
                    ...
                    <div className="pl-10">
                        <h2 className="font-bold text-4xl hover:text-blue-700 cursor-pointer mb-3" onClick={() => {
                            // navigate(`/detail-task/${postData._id}`);
                        }}>
                            {postData.title}
                        </h2>
                                ...
                                postData.hashtags.map((tag, index) => {
                                    return (
                                        <Link
                                            to="#"
                                            key={index}
                                            className="p-2 rounded-md hover:bg-gray-300/30"
                                        >
                                            {tag}
                                        </Link>
                                    )
