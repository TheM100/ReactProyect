...
function NewPostForm() {
    ...
    return (
        <>
            <div className="bg-white border border-solid rounded-lg py-10 px-10">

                <form className='flex flex-col gap-5' onSubmit={handleSubmit((data) => console.log(data))}>
                    <Button text='Add cover image' />
                    ...
                    {/* Toolbar */}
                    <div class="crayons-article-form__toolbar bg-gray-100 py-4">
                        <div class="editor-toolbar flex items-center gap-4 sticky">
                            <button tabindex="0" aria-label="Bold"
                                class="c-btn c-btn--icon-alone crayons-tooltip__activator toolbar-btn mr-1">
                                <svg height="24" viewBox="0 0 24 24" width="24" class="crayons-icon">
                                    <path
                            ...
                            <button class="c-btn c-btn--icon-alone crayons-tooltip__activator toolbar-btn mr-1">
                                <svg height="24" viewBox="0 0 24 24" width="24" class="crayons-icon">
                            ...
                            <button type="button" tabindex="-1" aria-label="Upload image" class="c-btn c-btn--icon-alone crayons-tooltip__activator toolbar-btn formatter-btn mr-1"><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" class="crayons-icon c-btn__icon"><path d="M20 5H4v14l9.292-9.294a1 1 0 011.414 0L20 15.01V5zM2 3.993A1 1 0 012.992 3h18.016c.548 0 .992.445.992.993v16.014a1 1 0 01-.992.993H2.992A.993.993 0 012 20.007V3.993zM8 11a2 2 0 110-4 2 2 0 010 4z"></path></svg><span data-testid="tooltip" class="crayons-tooltip__content">
                                {/* <span aria-hidden="true">Upload image</span> */}
                            </span>
                            </button>
                            <button type="button" id="overflow-menu-button" aria-expanded="false" aria-haspopup="true" tabindex="-1" aria-label="More options" class="c-btn c-btn--icon-alone toolbar-btn ml-auto"><svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" class="crayons-icon c-btn__icon"><path fill-rule="evenodd" clip-rule="evenodd" d="M12 17a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm0-7a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm2-5a2 2 0 1 0-4 0 2 2 0 0 0 4 0Z"></path></svg></button>
